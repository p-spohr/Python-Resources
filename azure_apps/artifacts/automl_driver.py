...
workspace_name = "AML-WS-Practice" # PLACEHOLDER
subscription_id = "94c249b3-2d1c-47e0-8be0-61b3bb50c87d" # PLACEHOLDER
resource_group = "RG-ML-Practice" # PLACEHOLDER
experiment_name = "diabetes-experiment" # PLACEHOLDER
iteration = "9"  # PLACEHOLDER
run_id = "diabetes-aml-001_9"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'is_subgraph_orchestration':False,'is_automode':True,'path':'./sample_projects/diabetes-experiment','subscription_id':'94c249b3-2d1c-47e0-8be0-61b3bb50c87d','resource_group':'RG-ML-Practice','workspace_name':'AML-WS-Practice','iterations':10,'primary_metric':'accuracy','task_type':'classification','IsImageTask':False,'IsTextDNNTask':False,'test_size':0.1,'n_cross_validations':None,'preprocess':True,'is_timeseries':False,'time_column_name':None,'grain_column_names':None,'max_cores_per_iteration':-1,'max_concurrent_iterations':1,'max_nodes':1,'iteration_timeout_minutes':15,'enforce_time_on_windows':False,'experiment_timeout_minutes':60,'exit_score':'NaN','experiment_exit_score':'NaN','whitelist_models':None,'blacklist_models':None,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':True,'enable_onnx_compatible_models':False,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':True,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':10,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'maximize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'is_gpu_tmp':False,'enable_run_restructure':False,'featurization':'auto','vm_type':'Standard_D2as_v4','vm_priority':'dedicated','label_column_name':'Diabetic','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'classification','primary_metric':'accuracy','verbosity':20,'ensemble_iterations':10,'ensemble_download_models_timeout_sec':300,'is_timeseries':False,'subscription_id':'94c249b3-2d1c-47e0-8be0-61b3bb50c87d','time_column_name':None,'grain_column_names':None}\",\"ensemble_run_id\":\"diabetes-aml-001_9\",\"experiment_name\":\"diabetes-experiment\",\"workspace_name\":\"AML-WS-Practice\",\"subscription_id\":\"94c249b3-2d1c-47e0-8be0-61b3bb50c87d\",\"resource_group_name\":\"RG-ML-Practice\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"azureml://locations/germanywestcentral/workspaces/70f68ca3-4320-45c5-9a3f-a8b3b607c3d9/data/training-data/versions/1\",\"ResolvedUri\":\"azureml://subscriptions/94c249b3-2d1c-47e0-8be0-61b3bb50c87d/resourcegroups/RG-ML-Practice/workspaces/AML-WS-Practice/datastores/workspaceblobstore/paths/UI/2026-03-05_111127_UTC/diabetes-data/\",\"AssetId\":\"azureml://locations/germanywestcentral/workspaces/70f68ca3-4320-45c5-9a3f-a8b3b607c3d9/data/training-data/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
